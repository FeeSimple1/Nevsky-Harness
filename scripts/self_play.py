...
# R202: event-implement arg generation now lives in src/nevsky/event_args.py
# (single source of truth, shared with the harness's legal_moves +
# aow_implement handler). Re-exported here for the agent code below.
from nevsky.event_args import _populate_event_args, _expand_event_variants  # noqa: E402,F401
