...
- **`withdraw`** — into a Friendly Stronghold at the Battle Locale.
  ...
  (optional, PLAY-26): subset that goes inside ("some or all ... up to
  Siege Capacity"); the cap is cumulative across partial Withdraws
  (`CombatPending.withdrawn_lords`). Remaining outside defenders then
  Avoid/Withdraw more or Stand and fight.
